...
const page = ({ user, baseURL, orderId }) => {
    ...
    console.log("asda",CurrentOrder.orderStatus && CurrentOrder?.orderStatus[0].timestamp);
      ...
      <div className="orders-head">
        <div className="Row JC-SB">
          ...
          <div className="head-btns Row ">
            ...
            <Button disabled={totalOrders < 1 ? true : false } icon={<FilePdfOutlined />}>Download Invoice</Button>
          </div>
        </div>
        <Breadcrumb
          items={[
      ...
      {!loading ?
        <div className="Row JC-SB">
          <div className="orders-left-section">
            ...
            description={
              <span>
               You currently have no orders. Start exploring our products and place
                your first order to see it here.
              </span>
            }
          >
            <Link href={"/"}><Button type="primary">Order Now</Button></Link>
                ...
                <div className="Row JC-SB">
                  ...
                  <div className="Row Vertical">
                    <Button type="primary" size="small">
                      {CurrentOrder?.orderStatus && CurrentOrder.orderStatus[phase].status}
                    </Button>
                  </div>
                </div>
              </div>
              ...
              items={[
                {
                  ...
                  subTitle: convertDateFormat2(CurrentOrder.orderStatus && CurrentOrder?.orderStatus[0].timestamp),
                  description:
                ...
                },
                {
                  title: "Order packed",
                  ...(phase >= 1 && {
                    subTitle: convertDateFormat2(CurrentOrder.orderStatus && CurrentOrder?.orderStatus[1].timestamp),
                      }),
                  ...(phase > 1 && {
                ...
                },
                {
                  title: "Package send",
                  ...(phase >= 2 && {
                  subTitle: convertDateFormat2(CurrentOrder.orderStatus && CurrentOrder?.orderStatus[2].timestamp),
                    }),
                  ...(phase > 2 && {
                ...
                },
                {
                  ...
                  ...(phase >= 3 && {
                    subTitle: convertDateFormat2(CurrentOrder.orderStatus && CurrentOrder?.orderStatus[3].timestamp),
                      }), 
                  ...(phase > 3 && {
